...
public class ClientProxy implements IProxy {
    ...
    public void init() {
        ...
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ManagerBlocks.electric_cable_2), new ItemRenderCableMedium());
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ManagerBlocks.iron_pipe), new ItemRenderIronPipe());
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileIronPipe.class, new TileRenderPipeBronce());
        ClientRegistry.bindTileEntitySpecialRenderer(TileElectricCableMedium.class, new TileRenderCableMedium());
    }
}
