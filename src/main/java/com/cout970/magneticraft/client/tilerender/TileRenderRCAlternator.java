...
public class TileRenderRCAlternator extends TileEntitySpecialRenderer {

    private ModelAlternator model;

    public TileRenderRCAlternator() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y,
        ...
        TileRCAlternator tile = (TileRCAlternator) te;
        ...
        RenderUtil.bindTexture(ModelTextures.RC_ALTERNATOR);
