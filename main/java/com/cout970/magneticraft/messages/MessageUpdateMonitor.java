...
public class MessageUpdateMonitor implements IMessage, IMessageHandler<MessageUpdateMonitor, IMessage>{

	public int x, y, z;
	public NBTTagCompound nbt;

	public MessageUpdateMonitor(){}

	public MessageUpdateMonitor(TileEntity t){
		x = t.xCoord;
		y = t.yCoord;
		z = t.zCoord;
	...
	@Override
	public IMessage onMessage(MessageUpdateMonitor message, MessageContext ctx) {
