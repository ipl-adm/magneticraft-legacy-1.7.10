...
public interface IPressureConductor extends IConnectable {
	...
	/**
	 * Ideal Gas constant units: (Pa*m^3)/(mol*K) or J/(mol*K)
	 */
	public static final double R = 8.3144621;

	/**
	 * the volume should be in mB mili Buckets volume must be more than 0
	 * 
	 * @return
	 */
	...
	/**
	 * add or remove gass from the conductor, the values must be positive and
	 * the units moles
	 */

	/**
	 * @param gas
	 * @return the amount accepted by the conductor, will be 0 if the fluid is
	 *         not valid(no gas or diferent fluid) or the same amount as the
	 *         fluidstack.
	 */
