...
//Taken from AgriCraft (https://github.com/InfinityRaider/AgriCraft/blob/1.7.10/src/main/java/com/InfinityRaider/AgriCraft/renderers/particles/AgriCraftFX.java)

@SideOnly(Side.CLIENT)
public abstract class ExtendedFX extends EntityFX {
    protected final ResourceLocation texture;

    private ExtendedFX(World world, double x, double y, double z, float scale, float gravity, Vec3 vector, ResourceLocation texture) {
    ...
    protected ExtendedFX(World world, double x, double y, double z, float scale, float gravity, Vec3 vector, IIcon icon) {
        super(world, x, y, z, 0, 0, 0);
        this.texture = null;
