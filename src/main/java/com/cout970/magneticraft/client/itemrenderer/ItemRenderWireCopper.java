...
public class ItemRenderWireCopper implements IItemRenderer {
    ...
    public void render(float x, float y, float z, float scale, ItemStack i) {
        ...
        RenderUtil.bindTexture(ModelTextures.WIRE_COPPER);
        model.renderDynamic(0.0625f, (byte) 255);
