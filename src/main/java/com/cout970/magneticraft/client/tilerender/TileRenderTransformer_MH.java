...
public class TileRenderTransformer_MH extends TileEntitySpecialRenderer {

    private ModelTransformer_MH model;

    public TileRenderTransformer_MH() {
        model = new ModelTransformer_MH();
    }
