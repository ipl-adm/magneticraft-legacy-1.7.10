...
public class GuiBasicGenerator extends GuiBasic {
    ...
    public void initComponents() {
        ...
        comp.add(new CompBurningTime(new ResourceLocation(Magneticraft.NAME.toLowerCase(Locale.US) + ":textures/gui/fire.png"), new GuiPoint(41, 32), ((TileBasicGenerator) tile).getBurningTimeBar()));
        comp.add(new CompHeatBar(new ResourceLocation(Magneticraft.NAME.toLowerCase(Locale.US) + ":textures/gui/heatbar.png"), new GuiPoint(60, 23), ((TileBasicGenerator) tile).heat));
        comp.add(new CompInfoDisplay(new GuiPoint(124, 16)));
        comp.add(new CompFluidRender(((TileBasicGenerator) tile).water, new GuiPoint(72, 28), new GuiPoint(90, 67), new ResourceLocation(Magneticraft.NAME.toLowerCase(Locale.US) + ":textures/gui/tank.png")));
        comp.add(new CompFluidRender(((TileBasicGenerator) tile).steam, new GuiPoint(97, 28), new GuiPoint(115, 67), new ResourceLocation(Magneticraft.NAME.toLowerCase(Locale.US) + ":textures/gui/tank.png")));
