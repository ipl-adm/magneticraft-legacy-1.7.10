...
public class TileRenderCrusher extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity t, double x, double y, double z, float frames) {
		...
		if(meta >= 8){
			...
			VecDouble vec = null;
			switch(meta%8){
			case 0: vec = new VecDouble(-1.5f, -0.5f, 0.5f); break;
			case 1: vec = new VecDouble(-0.5f, -0.5f, -0.5f); break;
			case 2: vec = new VecDouble(-0.5f, -0.5f, 0.5f); break;
			case 3: vec = new VecDouble(-1.5f, -0.5f, -0.5f); break;
			case 4: vec = new VecDouble(-1.5f, -0.5f, 0.5f); break;
			case 5: vec = new VecDouble(-0.5f, -0.5f, -0.5f); break;
			case 6: vec = new VecDouble(-0.5f, -0.5f, 0.5f); break;
			case 7: vec = new VecDouble(-1.5f, -0.5f, -0.5f); break;
			default: vec = new VecDouble(0, 0, 0);
			}
