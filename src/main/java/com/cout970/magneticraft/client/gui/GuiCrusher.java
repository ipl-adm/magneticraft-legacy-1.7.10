...
public class GuiCrusher extends GuiBasic {
    ...
    public void initComponents() {
        ...
        comp.add(new CompProgressBar(new ResourceLocation(Magneticraft.NAME.toLowerCase() + ":textures/gui/progresbar1.png"), new GuiPoint(75, 31), ((TileCrusher) tile).getProgressBar()));
    }
