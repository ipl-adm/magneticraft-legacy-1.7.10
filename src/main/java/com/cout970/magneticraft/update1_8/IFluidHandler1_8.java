...
public interface IFluidHandler1_8 extends net.minecraftforge.fluids.IFluidHandler {
    ...
    default int fillMg(MgDirection from, FluidStack resource, boolean doFill) {
        return fill(from.toEnumFacing(), resource, doFill);
    }
