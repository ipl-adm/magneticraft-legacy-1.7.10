...
public class ItemRenderCableLow implements IItemRenderer {

    public ModelCableLow model = new ModelCableLow();
    ...
    public void render(float x, float y, float z, float scale, ItemStack i) {
        ...
        RenderUtil.bindTexture(new ResourceLocation("magneticraft:textures/misc/modelcablelow.png"));
        model.render(0.0625f, (byte) 60);
