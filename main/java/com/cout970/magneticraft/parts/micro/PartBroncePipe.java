...
public class PartBroncePipe extends PartPipe implements ISidedHollowConnect{
	
	public boolean[] connections = new boolean[7];
	public static List<Cuboid6> boxes = new ArrayList<Cuboid6>();
	
	public PartBroncePipe() {
		super(ManagerItems.partbroncepipe);
	}
	...
	public static final int MAX_ACCEPT = 1000;
	...
	public IFluidTank getTank() {
		if(buffer == null)buffer = new TankMg(tile(), 500);
		return buffer;
	}
	...
	public boolean isComaptible(IFluidTransport a) {
		return a instanceof PartBroncePipe;
	}
}