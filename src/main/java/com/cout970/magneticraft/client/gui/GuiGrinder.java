...
public class GuiGrinder extends GuiBasic{
	...
	public void initComponenets() {
		...
		comp.add(new CompProgresBar(new ResourceLocation(Magneticraft.NAME.toLowerCase()+":textures/gui/progresbar1.png"), new GuiPoint(75, 31), ((TileGrinder)tile).getProgresBar()));
	}
