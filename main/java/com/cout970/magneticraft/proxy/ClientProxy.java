...
//		MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ManagerBlocks.windmill), new ItemRenderWindMill());
		MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ManagerBlocks.reactor_vessel), new ItemRenderReactorVessel());
		MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(ManagerBlocks.reactor_control), new ItemRenderReactorControl());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileReactorControl.class,new TileRenderReactorControl());
